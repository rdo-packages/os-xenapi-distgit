...
find %{buildroot}%{python3_sitelib}/%{module}/utils -type f -name "*.py" | xargs chmod a+x
find %{buildroot}%{python3_sitelib}/%{module}/utils -type f -name "*.sh" | xargs chmod a+x
find %{buildroot}%{python3_sitelib}/%{module}/utils -type f -name "*.py" | xargs sed -i 's|#!/usr/bin/env python|#!/usr/bin/env python3|g
